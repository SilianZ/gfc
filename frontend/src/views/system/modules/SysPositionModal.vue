    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          required
          label="账号角色编码">
          <a-input placeholder="请输入账号角色编码" v-model="model.code" :read-only="readOnly"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          ...
          required
          label="账号角色名称">
          <a-input placeholder="请输入账号角色名称" v-model="model.name"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          code: [
              { required: true, message: '请输入账号角色编码' },
              {
          ...
          name: [{ required: true, message: '请输入账号角色名称' }] ,
