<template>
    <a-card :bordered="false">
      ...
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="虚拟货币投资" key="6">
          <line-chart-multid ref="lineChart" title="虚拟货币投资" :height="height"/>
        </a-tab-pane>
      </a-tabs>
      ...
      <biz-virtual-currency-modal ref="modalForm" @ok="modalFormOk"></biz-virtual-currency-modal>
    </a-card>
  </template>
  ...
  import BizVirtualCurrencyModal from './modules/BizVirtualCurrencyModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import LineChartMultid from './BizVirtualCurrencyLineChart.vue'
  import {httpAction, getAction} from '@/api/manage'
  
  export default {
    name: 'BizVirtualCurrencyList',
    mixins: [JeecgListMixin, mixinDevice],
    components: {
      BizVirtualCurrencyModal, LineChartMultid
    },
    data() {
      return {
        description: '虚拟货币投资页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/biz/bizVirtualCurrency/list",
          delete: "/biz/bizVirtualCurrency/delete",
        },
        dictOptions: {},
        superFieldList: [],
      }
    ...
    methods: {
      ...
      fetchChartData() {
        const httpurl = '/biz/bizFiscalYear/getYearNameAndVirtualCurrencyInc';  // 后端提供的获取数据的 URL
