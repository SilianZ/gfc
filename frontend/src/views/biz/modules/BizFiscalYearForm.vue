  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="财年名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="yearName">
              <a-input v-model="model.yearName" placeholder="请输入财年名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
           yearName: [
              { required: true, message: '请输入财年名称!'},
              { validator: (rule, value, callback) => validateDuplicateValue('biz_fiscal_year', 'year_name', value, this.model.id, callback)},
           ],
        },
        url: {
          add: "/biz/bizFiscalYear/add",
          edit: "/biz/bizFiscalYear/edit",
          queryById: "/biz/bizFiscalYear/queryById"
        }
      }
    },
    computed: {
