 ...
 */
@Data
@TableName("biz_fiscal_year")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="biz_fiscal_year对象", description="财年信息")
public class BizFiscalYear implements Serializable {
	...
	/**状态*/
	@Excel(name = "状态", width = 15, dicCode = "fiscal_year_status")
	@Dict(dicCode = "fiscal_year_status")
