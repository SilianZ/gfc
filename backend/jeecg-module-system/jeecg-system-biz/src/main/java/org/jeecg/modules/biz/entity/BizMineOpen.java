 ...
 */
@Data
@TableName("biz_mine_open")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="biz_mine_open对象", description="资源开采")
public class BizMineOpen implements Serializable {
	...
	/**材料工厂*/
	@Excel(name = "材料工厂", width = 15, dictTable = "biz_team_resource", dicText = "resource_name", dicCode = "id")
	@Dict(dictTable = "biz_team_resource", dicText = "resource_name", dicCode = "id")
    @ApiModelProperty(value = "材料工厂")
    private java.lang.String factoryId;
	/**开采计划*/
	@Excel(name = "开采计划", width = 15, dictTable = "biz_mine_plan", dicText = "plan_name", dicCode = "plan_code")
	@Dict(dictTable = "biz_mine_plan", dicText = "plan_name", dicCode = "plan_code")
    @ApiModelProperty(value = "开采计划")
    private java.lang.String planCode;
	/**备注*/
	@Excel(name = "备注", width = 15)
    @ApiModelProperty(value = "备注")
    private java.lang.String remakr;
	/**创建人*/
