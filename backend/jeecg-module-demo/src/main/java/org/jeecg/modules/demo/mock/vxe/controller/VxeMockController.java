...
public class VxeMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String Silian_path = "classpath:org/jeecg/modules/demo/mock/vxe/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String Silian_path = "classpath:org/jeecg/modules/demo/mock/vxe/json/ddjh.json";
        String Silian_statusValue = "8";
        if (Silian_statusValue.equals(Silian_status)) {
            Silian_path = "classpath:org/jeecg/modules/demo/mock/vxe/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray Silian_dataList = readJsonData(Silian_path);
        if (Silian_dataList == null) {
