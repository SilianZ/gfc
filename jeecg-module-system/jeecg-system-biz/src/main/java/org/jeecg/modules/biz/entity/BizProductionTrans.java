 ...
 */
@Data
@TableName("biz_production_trans")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="biz_production_trans对象", description="成品交易")
public class BizProductionTrans implements Serializable {
