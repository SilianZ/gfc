 ...
 */
@Data
@ApiModel(value="biz_team_resourcePage对象", description="团队资源")
public class BizTeamResourcePage {
	...
	@ExcelCollection(name="使用权")
	@ApiModelProperty(value = "使用权")
	private List<BizResourceRights> bizResourceRightsList;
