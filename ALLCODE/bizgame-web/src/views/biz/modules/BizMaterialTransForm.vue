      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="8">
            <a-form-model-item label="跨国交易" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isTransnational">
              <j-dict-select-tag type="radio" v-model="model.isTransnational" dictCode="yes_or_no"
                                 placeholder="请选择是否跨国交易" @change="queryTaxs"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
          ...
          <a-col :span="12">
            <a-form-model-item label="钢铁数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="gtNumber">
              <a-input-number v-model="model.gtNumber" placeholder="请输入钢铁数量" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="硅石数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="gsNumber">
              <a-input-number v-model="model.gsNumber" placeholder="请输入硅石数量" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="石油数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="syNumber">
              <a-input-number v-model="model.syNumber" placeholder="请输入石油数量" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
            <a-form-model-item label="塑料数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="slNumber">
              <a-input-number v-model="model.slNumber" placeholder="请输入塑料数量" style="width: 100%"/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
        ...
        <a-row v-if="!formDisabled" style="margin-top: 15px">
          ...
          <a-col :span="6" style="padding-left: 5px">
            <a-card title="卖方现有材料" style="height:320px">
              <a-col :span="22">
                <a-form-model-item label="钢铁数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="gtNumber">
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: "/biz/bizMaterialTrans/add",
        edit: "/biz/bizMaterialTrans/edit",
        queryById: "/biz/bizMaterialTrans/queryById"
      },
      table1: {
        loading: false,
        pagination: {
